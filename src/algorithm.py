...
if __name__ == "__main__":
    ...
    conf_matrix_rf = ml_algo_rf.confusion_matrix(name="arff_*.txt") # Replace arff_*.txt with your ARFF filename
    ...
    conf_matrix_nb = ml_algo_nb.confusion_matrix(name="arff_*.txt") # Replace arff_*.txt with your ARFF filename
